...
rs::httpserver::request_headers_ptr rs::httpserver::RequestHeaders::Create(const Buffer& buffer) {
...
void rs::httpserver::RequestHeaders::GetHeaders(const Buffer& buffer, int headersLength) {
