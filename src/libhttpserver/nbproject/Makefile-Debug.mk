...
${TESTDIR}/tests/chunked_response_stream_tests.o: tests/chunked_response_stream_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/installed/include -I. -std=c++11 --coverage -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/chunked_response_stream_tests.o tests/chunked_response_stream_tests.cpp
...
${TESTDIR}/tests/request_header_tests.o: tests/request_header_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/installed/include -I. -std=c++11 --coverage -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/request_header_tests.o tests/request_header_tests.cpp


${TESTDIR}/tests/writable_string_stream_tests.o: tests/writable_string_stream_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/installed/include -I. -std=c++11 --coverage -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/writable_string_stream_tests.o tests/writable_string_stream_tests.cpp
