...
${TESTDIR}/tests/ChunkedRequestStreamTests.o: tests/ChunkedRequestStreamTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ChunkedRequestStreamTests.o tests/ChunkedRequestStreamTests.cpp


${TESTDIR}/tests/ChunkedRequestStreamTestsRunner.o: tests/ChunkedRequestStreamTestsRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ChunkedRequestStreamTestsRunner.o tests/ChunkedRequestStreamTestsRunner.cpp


${TESTDIR}/tests/StringStreamTests.o: tests/StringStreamTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringStreamTests.o tests/StringStreamTests.cpp


${TESTDIR}/tests/StringStreamTestsRunner.o: tests/StringStreamTestsRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringStreamTestsRunner.o tests/StringStreamTestsRunner.cpp
